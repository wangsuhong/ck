	...
	<body>
		<div class="card">
			...
			<div class="card-body">
				<div style="height: 30px;"></div>
				 <form class="form-horizontal" action="GoodsServlet?method=GoodsUpdate" method="post" id="myform">
				    <input type="hidden" class="form-control" name="id" id="id" value="${goods.id}" />
				    <input type="hidden" class="form-control" name="oldgoodsid" id="oldgoodsid" value="${goods.goodsid}" />
					<label class="col-md-3 control-label">货物编号</label>
					<div class="col-xs-4">
						<input type="text" class="form-control" name="goodsid" id="goodsid" value="${goods.goodsid}" />
					</div>
					...
					<div class="col-xs-4">
						<input type="text" class="form-control" name="goodsnum" id="goodsnum" value="${goods.goodsnum}" />
					</div>
					...
					<div class="col-xs-4">
						<input type="text" class="form-control" name="typename" id="typename" value="${goods.typename}" />
					</div>
					<div style="height: 50px;"></div>
					<label class="col-md-3 control-label">货物登记时间</label>
					<div class="col-xs-4">
						<input class="form-control js-datetimepicker" type="text" id="date" name="date" value="${goods.date}" data-side-by-side="true"
						data-format="YYYY-MM-DD HH:mm:ss" />
					</div>
					<div style="height: 50px;"></div>
					<label class="col-md-3 control-label">供货商编号</label>
					<div class="col-xs-4">
						<input type="text" class="form-control" name="proid" id="proid" value="${goods.proid}" />
					</div>
					<div style="height: 50px;"><a id="proidMsg"></a></div>
					<label class="col-md-3 control-label">货物介绍</label>
					<div class="col-xs-4">
						<input type="text" class="form-control" name="goodsdesc" id="goodsdesc" value="${goods.goodsdesc}" />
					</div>
					<div style="height: 50px;"></div>
		...
		function checkGoodsid(goodsid){
			$.ajax({
				...
				//已经存在提示用户
				    if(s == "1"){
					$("#goodsidMsg").html("该货物编号已登记");
					}else{
					$("#goodsidMsg").html("该货物编号未登记");
					}
				  }
				})
			  }	
