...
<html lang="zh">
	...
	<body>
		<div class="card">
			...
			<div class="card-body">
				...
				<form class="form-horizontal" action="ProviderServlet?method=providerAdd" method="post" id="myform">
					...
					<div class="col-xs-4">
						<input type="text" class="form-control" name="proname" id="proname" value="" />
					</div>
					<div style="height: 50px;"></div>
					<label class="col-md-3 control-label">供货商邮箱</label>
					<div class="col-xs-4">
						<input type="text" class="form-control" name="proemail" id="proemail" value="" />
					</div>
					<div style="height: 50px;"></div>
					<label class="col-md-3 control-label">供货商电话</label>
					<div class="col-xs-4">
						<input type="text" class="form-control" name="prophone" id="prophone" value="" />
					</div>
					<div style="height: 50px;"></div>
					<label class="col-md-3 control-label">供货商介绍</label>
					<div class="col-xs-4">
						<input type="text" class="form-control" name="prodesc" id="prodesc" value="" />
					</div>
					<div style="height: 50px;"></div>
	...
	function checkProid(proid){
		$.ajax({
			...
			//提示数量
			    if(s == "1"){
				$("#proidMsg").html("供货商编号可以使用");
				}else{
				$("#proidMsg").html("供货商编号已存在!!!");
				}
			  }
			})
		  }	
